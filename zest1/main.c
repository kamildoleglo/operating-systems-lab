...
void print_result(char *name, struct timespec real_time_diff, struct tms system_time_begin, struct tms system_time_end);
...
void print_result_to_file(FILE *f, char *name, struct timespec real_time_diff, struct tms system_time_begin, struct tms system_time_end);
...
void run_tests(void) {
    ...
    struct tms system_time_begin, system_time_end;
    ...
    for (int i = 0; i < 8; i++) {
        ...
        print_result(func_names[i], real_time_diff, system_time_begin, system_time_end);
        print_result_to_file(f, func_names[i], real_time_diff, system_time_begin, system_time_end);
...
void print_result(char *name, struct timespec real_time_diff, struct tms system_time_begin, struct tms system_time_end){
    ...
    printf("User time for %s = %f \r\n", name, (double) (system_time_end.tms_utime - system_time_begin.tms_utime) );
    printf("Kernel time for %s = %f \r\n", name, (double) (system_time_end.tms_stime - system_time_begin.tms_stime));
    printf("\r\n");
}

void print_result_to_file(FILE *f, char *name, struct timespec real_time_diff, struct tms system_time_begin, struct tms system_time_end) {
    fprintf(f, "Real time for %s = %ld.%ld \r\n", name, real_time_diff.tv_sec, real_time_diff.tv_nsec );
    fprintf(f, "User time for %s = %f \r\n", name, (double) (system_time_end.tms_utime - system_time_begin.tms_utime) / CLOCKS_PER_SEC);
    fprintf(f, "Kernel time for %s = %f \r\n", name, (double) (system_time_end.tms_stime - system_time_begin.tms_stime) / CLOCKS_PER_SEC);
    fprintf(f, "\r\n");
}
